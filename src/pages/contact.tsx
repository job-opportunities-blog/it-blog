...
const Contact: React.FC = () => {
    ...
    <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-start">
      ...
      <div className="space-y-6">
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className={`text-xl font-bold mb-2 ${darkMode ? "text-gray-100" : "text-gray-800"}`}>
                Alamat Kami
              </h2>
        ...
        >
          ...
          <div className="flex items-center gap-4 mb-6">
            <div className="w-10 h-10 rounded-full bg-blue-600 hover:bg-blue-700 flex items-center justify-center transition-colors cursor-pointer">
              <Image name="linkedin" className="w-5 h-5 brightness-0 invert" />
            </div>
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 flex items-center justify-center transition-colors cursor-pointer">
              <Image name="instagram" className="w-5 h-5 brightness-0 invert" />
            </div>
            <div className="w-10 h-10 rounded-full bg-blue-500 hover:bg-blue-600 flex items-center justify-center transition-colors cursor-pointer">
              <Image name="facebook" className="w-5 h-5 brightness-0 invert" />
            </div>
          </div>
          ...
          >
            <ul className="space-y-3">
              {[
                { name: "LinkedIn – Politeknik Baja Tegal", href: "https://www.linkedin.com/" },
                { name: "Instagram – @poltekbajategal", href: "https://www.instagram.com/" },
                { name: "Facebook – Politeknik Baja Tegal", href: "https://facebook.com/" },
              ].map((social, idx) => (
                <li key={idx}>
                  <Link
                    to={social.href}
        ...
        <div
          ...
          `}
        >
          <h3 className={`text-xl font-bold mb-6 text-center ${darkMode ? "text-gray-100" : "text-gray-800"}`}>
            Partner & Akreditasi
          </h3>
          ...
          <div className="max-w-3xl mx-auto grid grid-cols-2 md:grid-cols-4 space-x-2 md:gap-x-4 lg:gap-x-2 gap-y-10 place-items-center pb-10">
            <Image name="pbjt" className="w-32 md:w-16 lg:w-20 opacity-80 hover:opacity-100 transition-opacity" />
            <Image name="kampus-vokasi" className="w-34 md:w-20 lg:w-24 opacity-80 hover:opacity-100 transition-opacity" />
            <Image name="banpt" className="w-28 md:w-16 lg:w-20 opacity-80 hover:opacity-100 transition-opacity" />
            <Image name="informatika" className="w-32 md:w-16 lg:w-20 opacity-80 hover:opacity-100 transition-opacity" />
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-center items-start">
        <div
          ...
          `}
        >
          <Image name="/contact" alt="Contact illustration" className="w-full max-w-md mx-auto" />
  ...
  <section className="py-12 px-4">
    <div className="max-w-6xl mx-auto">
      <h2 className={`text-3xl font-bold mb-8 text-center ${darkMode ? "text-gray-100" : "text-gray-800"}`}>
        Lokasi Kami
      </h2>
      <div
        className={`
